...
class TestPracticalE2EScenarios:
    ...
    def test_complete_code_quality_audit(self):
        ...
        improved_analysis = {
            ...
            'summary': {
                'total_violations': len(improved_violations),
                'files_analyzed': 6
            }
        }
    ...
    def test_continuous_improvement_tracking(self):
        ...
        for cycle_num in range(5):
            ...
            analysis = {
                'violations': [
                    {'type': ['identity', 'algorithm', 'timing'][i % 3],
    ...
    def test_multi_project_quality_comparison(self):
        ...
        projects = {
            ...
            'microservice_a': {
                'violations': [
                    {'type': t, 'severity': s}
                    for t in ['identity', 'meaning'] * 5
                    for s in ['medium', 'low']
                ]
            },
            'new_api': {
                'violations': [
                    {'type': 'type', 'severity': 'low'} for _ in range(3)
                ]
            }
        }
        ...
        for project_name, project_data in projects.items():
            analysis = {
                ...
                'summary': {
                    'total_violations': len(project_data['violations']),
                    'files_analyzed': 20
                }
            }
    ...
    def test_quality_gate_enforcement(self):
        ...
        low_quality = {
            'violations': [
                {'type': t, 'severity': 'critical'}
                for t in ['algorithm', 'timing', 'execution'] * 3
            ]
        }
