    ...
    def _initialize_compliance_report(self) -> Dict[str, any]:
        ...
        return {
            ...
            "violation_summary": {
                ...
                "rule_6": 0, "rule_7": 0, "rule_8": 0, "rule_9": 0, "rule_10": 0
            },
            "critical_violations": [],
...
def test_nasa_power_of_ten_compliance():
    ...
    assert compliance_report['compliance_score'] >= 85.0, f"Compliance score too low: {compliance_report['compliance_score']}%"
