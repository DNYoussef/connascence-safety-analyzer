...
from analyzer.constants import MAX_ANALYSIS_TIME_SECONDS, MAX_FILE_SIZE_KB
...
'''
    ...
    def test_medium_file_performance(self):
        ...
        with PerformanceMonitor() as monitor:
            violations = self._analyze_code_string(medium_file_code)
    ...
    def test_large_file_performance(self):
        ...
        with PerformanceMonitor() as monitor:
            violations = self._analyze_code_string(large_file_code)
    ...
    def test_directory_analysis_performance(self):
        ...
        print(f"Directory analysis performance:")
    ...
    def test_concurrent_analysis_performance(self):
        ...
        with PerformanceMonitor() as sequential_monitor:
            sequential_results = [analyze_code(code) for code in test_codes]
        
        # Test concurrent execution
        with PerformanceMonitor() as concurrent_monitor:
            with concurrent.futures.ThreadPoolExecutor(max_workers=3) as executor:
                concurrent_results = list(executor.map(analyze_code, test_codes))
...
class TestPerformanceBenchmarks:
    ...
    def test_baseline_benchmark_small_project(self):
        ...
        print(f"Small project benchmark:")
    ...
    def test_baseline_benchmark_medium_project(self):
        ...
        print(f"Medium project benchmark:")
