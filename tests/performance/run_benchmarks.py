...
from tests.performance.benchmark_runner import PerformanceBenchmarker, BenchmarkResult
from analyzer.optimization.incremental_analyzer import get_incremental_analyzer
from analyzer.caching.ast_cache import ast_cache, optimize_cache, clear_cache
