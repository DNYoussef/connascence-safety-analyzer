...
- **Usage**: Store API development state, coordinate with other agents, maintain backend context
- **Commands**: 
...
- **Purpose**: Structured step-by-step reasoning and systematic API development
- **Activation**: `npx ruv-swarm neural_patterns --pattern="sequential"`
- **Usage**: Methodical API design, systematic endpoint implementation, logical backend development progression
- **Commands**:
...
**⚠️ ALWAYS activate these MCPs at the start of your work before beginning any backend development task.**
