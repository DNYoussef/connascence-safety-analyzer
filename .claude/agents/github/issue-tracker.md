...
- **Usage**: Store issue tracking state, coordinate with other agents, maintain project management context
- **Commands**: 
...
- **Usage**: Methodical issue tracking, systematic project coordination, logical workflow progression
- **Commands**:
...
**⚠️ ALWAYS activate these MCPs at the start of your work before beginning any issue management task.**
