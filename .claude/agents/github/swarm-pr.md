...
- **Usage**: Store PR coordination state, coordinate with other agents, maintain code review context
- **Commands**: 
...
- **Usage**: Methodical PR analysis, systematic review coordination, logical integration workflows
- **Commands**:
...
- **Usage**: Enhanced PR management, automated code review, swarm-coordinated integration workflows
- **Commands**:
  - PR ops: `mcp__github__get_pull_request`, `mcp__github__create_pull_request`, `mcp__github__update_pull_request`
  - Review ops: `mcp__github__create_pr_review`, `mcp__github__submit_pr_review`
  - Comment ops: `mcp__github__create_pr_comment`, `mcp__github__list_pr_comments`
  - Merge ops: `mcp__github__merge_pull_request`, `mcp__github__get_pr_diff`

**⚠️ ALWAYS activate these MCPs at the start of your work before beginning any PR coordination task.**
