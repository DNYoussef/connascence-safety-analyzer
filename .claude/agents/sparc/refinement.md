...
- **Usage**: Store refinement progress, coordinate with other agents, maintain optimization context
- **Commands**: 
...
- **Purpose**: Structured step-by-step reasoning and systematic code refinement
- **Activation**: `npx ruv-swarm neural_patterns --pattern="sequential"`
- **Usage**: Methodical code improvement, systematic testing approach, logical refinement progression
- **Commands**:
...
**⚠️ ALWAYS activate these MCPs at the start of your work before beginning any refinement task.**
