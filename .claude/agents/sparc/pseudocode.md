...
- **Usage**: Store algorithm designs, coordinate with other agents, maintain pseudocode context
- **Commands**: 
...
- **Purpose**: Structured step-by-step reasoning and systematic algorithm design
- **Activation**: `npx ruv-swarm neural_patterns --pattern="sequential"`
- **Usage**: Methodical algorithm development, systematic logic flow design, logical pseudocode progression
- **Commands**:
...
**⚠️ ALWAYS activate these MCPs at the start of your work before beginning any pseudocode task.**
