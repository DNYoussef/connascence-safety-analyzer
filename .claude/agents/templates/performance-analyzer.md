...
- **Usage**: Store performance analysis results, coordinate with other agents, maintain benchmarking context
- **Commands**: 
...
- **Purpose**: Structured step-by-step reasoning and systematic performance analysis
- **Activation**: `npx ruv-swarm neural_patterns --pattern="sequential"`
- **Usage**: Methodical bottleneck analysis, systematic optimization planning, logical performance investigation
- **Commands**:
...
- **Usage**: Performance data collection, benchmarking against industry standards, competitive performance analysis
- **Commands**:
...
**⚠️ ALWAYS activate these MCPs at the start of your work before beginning any performance analysis task.**
