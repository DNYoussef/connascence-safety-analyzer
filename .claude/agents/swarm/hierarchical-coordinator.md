...
- **Usage**: Store coordination decisions, coordinate with other agents, maintain hierarchical context
- **Commands**: 
...
- **Purpose**: Structured step-by-step reasoning and systematic coordination
- **Activation**: `npx ruv-swarm neural_patterns --pattern="sequential"`
- **Usage**: Methodical task decomposition, systematic delegation, logical coordination progression
- **Commands**:
...
**⚠️ ALWAYS activate these MCPs at the start of your work before beginning any coordination task.**
