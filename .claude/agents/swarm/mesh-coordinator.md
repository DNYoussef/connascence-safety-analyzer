...
- **Usage**: Store mesh network state, coordinate with other agents, maintain distributed context
- **Commands**: 
...
- **Purpose**: Structured step-by-step reasoning and systematic mesh coordination
- **Activation**: `npx ruv-swarm neural_patterns --pattern="sequential"`
- **Usage**: Methodical consensus building, systematic peer communication, logical network management
- **Commands**:
...
**⚠️ ALWAYS activate these MCPs at the start of your work before beginning any mesh coordination task.**
