...
- **Usage**: Store mobile development state, coordinate with other agents, maintain app context
- **Commands**: 
...
- **Purpose**: Structured step-by-step reasoning and systematic mobile development
- **Activation**: `npx ruv-swarm neural_patterns --pattern="sequential"`
- **Usage**: Methodical app architecture, systematic component development, logical mobile app progression
- **Commands**:
...
**⚠️ ALWAYS activate these MCPs at the start of your work before beginning any mobile development task.**
