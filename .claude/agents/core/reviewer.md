...
- **Usage**: Store review findings, coordinate with other agents, maintain review context
- **Commands**: 
...
- **Purpose**: Structured step-by-step reasoning and systematic review process
- **Activation**: `npx ruv-swarm neural_patterns --pattern="sequential"`
- **Usage**: Methodical code review, systematic analysis, logical evaluation progression
- **Commands**:
...
**⚠️ ALWAYS activate these MCPs at the start of your work before beginning any review task.**
