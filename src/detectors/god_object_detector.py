...
class GodObjectDetector(ast.NodeVisitor):
    ...
    def _calculate_class_metrics(self, node: ast.ClassDef) -> Dict[str, int]:
        ...
        return {"methods": method_count, "lines": line_count, "attributes": attribute_count}
    ...
    def _is_god_object(self, metrics: Dict[str, int]) -> bool:
        ...
        return metrics["lines"] > 500 or metrics["methods"] > 20 or metrics["attributes"] > 15
        ...
        if self._is_god_object(metrics):
            ...
            self.violations.append(
                ConnascenceViolation(
                    ...
                    context={"class_name": node.name, "metrics": metrics, "violations": violations},
                )
            )
