...
with open("C:/Users/17175/Desktop/connascence/analysis/dependency_analysis_report.json") as f:
    dep_report = json.load(f)

# Load Six Sigma metrics
with open("C:/Users/17175/Desktop/connascence/.connascence-six-sigma-metrics.json") as f:
...
enhanced_report = {
    ...
    "connascence_patterns": {
        ...
        "CoV_value": {
            ...
            "violations": {"meaning": 12.0, "identity": 0.0, "values": 0.0},
        ...
        "identified": [
            {
                ...
                "metrics": {"estimated_loc": ">800", "dependencies": 30, "fan_in": "Unknown (needs inspection)"},
    ...
    "mece_analysis": {
        ...
        "gap": 0.10,
        "factors": {
            "overlap": {"issue": "Circular dependencies create overlap", "count": 3, "penalty": 0.05},
            "gaps": {
...
print("   Root Cause: Documentation theater - docs exist but code doesn't implement patterns")
print("\n3. DPMO: 357,058 (target: 6,210)")
print("   Architectural Contribution: 90% of defects from god objects + circular deps + high coupling")
print(f"\n4. Circular Dependencies: {enhanced_report['circular_dependencies']['count']} critical cycles")
print("   Primary: analyzer <-> mcp <-> policy creates tight coupling web")
print("\n5. God Objects: 2+ identified")
print("   Impact: Fan-in of 157 to analyzer module indicates god object anti-pattern")
