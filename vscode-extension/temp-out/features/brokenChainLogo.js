...
exports.BrokenChainLogoManager = void 0;
...
class BrokenChainLogoManager {
    ...
    getChainStatusEmoji(qualityScore, criticalIssues) {
        if (criticalIssues > 0) {
    ...
    getStatusColor(qualityScore, criticalIssues) {
        if (criticalIssues > 0) {
    ...
    showBrokenChainAnimation() {
        if (this.webviewPanel) {
            this.webviewPanel.reveal();
            return;
        }
        this.webviewPanel = vscode.window.createWebviewPanel('brokenChainAnimation', '🔗💔 Breaking Chains Animation', vscode.ViewColumn.One, {
            enableScripts: true,
...
exports.BrokenChainLogoManager = BrokenChainLogoManager;
//# sourceMappingURL=brokenChainLogo.js.map