 ...
 */
class TelemetryServiceAdapter extends telemetryService_1.TelemetryService {
...
class ConnascenceExtension {
    constructor(context, logger, telemetry) {
        ...
        this.connascenceService = new connascenceService_1.ConnascenceService(this.configService, new TelemetryServiceAdapter(this.telemetry));
