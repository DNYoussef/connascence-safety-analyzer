...
class UnifiedASTVisitor(ast.NodeVisitor):
    ...
    def _collect_naming_conventions(self, node: Union[ast.ClassDef, ast.FunctionDef], node_type: str) -> None:
    ...
    def _check_naming_convention(self, node: Union[ast.ClassDef, ast.FunctionDef], node_type: str) -> Optional[str]:
