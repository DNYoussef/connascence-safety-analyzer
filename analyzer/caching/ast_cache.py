...
class CacheEntry:
    ...
    def is_valid(self) -> bool:
        ...
        try:
            ...
            return (abs(current_stat.st_mtime - self.file_mtime) < 1.0 and 
                   current_stat.st_size == self.file_size)
        except Exception:
            return False
...
class ASTCache:
    ...
    def get_analysis_result(self, file_path: Union[str, Path], analysis_type: str = 'connascence') -> Optional[Dict[str, Any]]:
    ...
    def invalidate_file(self, file_path: Union[str, Path]):
        ...
        with self.cache_lock:
            keys_to_remove = [
                ...
                if entry.file_path == str(file_path)
            ]
    ...
    def get_cache_statistics(self) -> Dict[str, Any]:
        ...
        with self.cache_lock:
            ...
            if self.memory_cache:
                ...
                durations = [entry.analysis_duration_ms for entry in self.memory_cache.values() if entry.analysis_duration_ms > 0]
    ...
    def optimize_cache(self):
        ...
        logger.info(f"Cache optimization complete: removed {removed_count} entries, "
    ...
    def warm_cache(self, file_paths: List[Union[str, Path]], max_workers: int = 4):
        ...
        logger.info(f"Cache warming complete: {cached_count} cached, "
