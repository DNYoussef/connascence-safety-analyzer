...
CON-007: Consolidated from src/detectors/detector_factory.py - removed sys.path injection
"""
...
class DetectorFactory:
    ...
    def __init__(self, file_path: str, source_lines: List[str]):
        ...
        self.detectors = [
            ...
            ConventionDetector(file_path, source_lines),
            ExecutionDetector(file_path, source_lines),
            TimingDetector(file_path, source_lines),
    ...
    def detect_all(self, tree: ast.AST) -> List[ConnascenceViolation]:
        ...
        for detector in self.detectors:
            try:
                violations = self._run_detector(detector, tree)
    ...
    def detect_by_type(self, tree: ast.AST, violation_types: List[str]) -> List[ConnascenceViolation]:
        ...
        type_mapping = {
            ...
            "connascence_of_values": ValuesDetector,
            "connascence_of_identity": IdentityDetector,
    ...
    def _run_detector(self, detector: Any, tree: ast.AST) -> List[ConnascenceViolation]:
        """Execute a detector regardless of API shape (detect vs detect_violations)."""
