...
class MasterDemoRunner:
    ...
    def run_demo(self, demo_name, demo_config):
        ...
        try:
            ...
            print(f"❌ {demo_name.upper()} failed: {str(e)}")
            return {
                'name': demo_name,
                'success': False,
                'error': str(e),
        ...
        with ThreadPoolExecutor(max_workers=3) as executor:
            ...
            for future in as_completed(future_to_demo):
                ...
                try:
                    ...
                    print(f"❌ Demo {demo_name} generated an exception: {e}")
                    results.append({
                        'name': demo_name,
                        'success': False,
                        'error': str(e)
...
**Overall Status**: {'✅ [DONE] SUCCESS' if len(successful_demos) == total_demos else '⚠️ [WARNING] PARTIAL SUCCESS'}
...
"""
        ...
        for result in results:
            ...
            status_icon = '✅ [DONE]' if result['success'] else '❌'
...
"""
    ...
    def run_complete_suite(self):
        ...
        if successful == total:
            ...
            print(f"\n⚠️ [WARNING] {total - successful} demo(s) had issues - check execution logs")
