...
- **5,743 total violations** detected across enterprise frameworks
...
1. **Celery (Python)** - Complete async framework (4,630 violations)
2. **curl (C)** - Industry-standard networking library (1,061 violations)  
3. **Express.js (JavaScript)** - Production web framework (52 violations)
...
├── Celery: 100% of repository analyzed (all files, all directories)
├── curl: 100% of C source code analyzed (complete codebase)
└── Express: 100% of JavaScript framework analyzed (complete repository)
